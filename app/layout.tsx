  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <meta
          name="description"
          content="LangChain.js Agent with tools - search and calculator"
        />
        <meta property="og:title" content="LangChain Agent" />
        <meta
        ...
        <meta name="twitter:title" content="LangChain Agent" />
        <meta
